...
public class Tab2 extends Fragment implements MyAdapter.AddPersonListener {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) rootview.findViewById(R.id.recycler_view_tab2);
...
//        DatabaseImageDataReference = database.getReference("Images");
        DatabaseInfoDataReference = database.getReference("Cat");
